namespace SumOfCoins
{
    ...
    public class SumOfCoins
    {
        ...
        public static Dictionary<int, int> ChooseCoins(IList<int> coins, int targetSum)
        {
            ...
            var chosenCoinsDictionary = new Dictionary<int, int>();
            var currentSum = 0;
            ...
            while (currentSum != targetSum && coinIndex < sortedCoins.Count)
            {
                ...
                {
                    chosenCoinsDictionary.Add(currentCoinValue, numberOfCoinsToTake);
            ...
            if (currentSum != targetSum)
            {
                throw new InvalidOperationException(
                    "Greedy algorithm cannot prdoce desired sum, with specified coins.");
            }

            return chosenCoinsDictionary;
        }
    }
}